	...
	async up(queryInterface, Sequelize) {
		const crossfitTerms = [
			...
			{ term: 'Z-Press', definition: 'жим над головой сидя' },
			{
				...
				definition: 'якнайбільше раундів за певний час.',
			},
			{ term: 'Box Jump', definition: 'стрибок на ящик.' },
			{
				term: 'Burpee',
				definition:
					'вправа, що складається зі стрибка, присідання та віджимання.',
			},
			{ term: 'CF (CrossFit)', definition: 'кросфіт.' },
			{
				term: 'Chipper',
				definition:
					'тренування, що складається з кількох вправ, виконуваних по одному разу.',
			},
			{ term: 'Clean', definition: 'підйом штанги від підлоги до плечей.' },
			{ term: 'Deadlift', definition: 'становий підйом.' },
			{
				term: 'Double Under',
				definition: 'два оберти скакалки за один стрибок.',
			},
			{
				term: 'EMOM (Every Minute on the Minute)',
				definition: 'кожну хвилину виконувати вправу.',
			},
			{
				term: 'Farmer’s Walk',
				definition: 'ходьба з важкими вагами в руках.',
			},
			{
				term: 'Frankenstein',
				definition: 'вправа, що поєднує присідання та жим штанги.',
			},
			{
				term: 'GHD (Glute Ham Developer)',
				definition: 'тренажер для тренування сідничних м’язів та стегон.',
			},
			{
				term: 'HSPU (Handstand Push-Up)',
				definition: 'віджимання в стійці на руках.',
			},
			{ term: 'Jerk', definition: 'поштовх штанги над головою.' },
			{ term: 'Kettlebell Swing', definition: 'мах з гирею.' },
			{ term: 'Lunge', definition: 'випад.' },
			{ term: 'MB (Medicine Ball)', definition: 'лікарський м’яч.' },
			{
				term: 'Metcon (Metabolic Conditioning)',
				definition: 'метаболічне тренування для підвищення витривалості.',
			},
			{
				term: 'OM (Overhead Squat)',
				definition: 'присідання з штангою над головою.',
			},
			{ term: 'Pistol', definition: 'присідання на одній нозі.' },
			{
				term: 'RDL (Romanian Deadlift)',
				definition: 'румунська становая тяга.',
			},
			{ term: 'Rings', definition: 'кільця для підтягувань.' },
			{ term: 'RO (Rowing)', definition: 'веслування.' },
			{ term: 'RX (prescribed)', definition: 'стандарт виконання вправи.' },
			{
				term: 'S2OH (Snatch to Overhead)',
				definition: 'ривок зі штангою над головою.',
			},
			{
				term: 'Snatch',
				definition: 'ривок, підйом штанги над головою в один рух.',
			},
			{ term: 'Squat', definition: 'присідання.' },
			{ term: 'SS (Single-Squats)', definition: 'присідання на одній нозі.' },
			{ term: 'Ski Erg', definition: 'тренажер для схожості рухів на лижах.' },
			{ term: 'Sled Push', definition: 'поштовх коляски.' },
			{ term: 'Strength', definition: 'сила.' },
			{ term: 'Strict Pull-ups', definition: 'підтягування без підкачки.' },
			{
				term: 'Tabata',
				definition:
			...
			{ term: 'Thruster', definition: 'присідання з поштовхом.' },
			{ term: 'Tire Flip', definition: 'перевертач шини.' },
			{ term: 'Toes to Bar', definition: 'підйом ніг до перекладини.' },
			{
				term: 'Triple Under',
				definition: 'три оберти скакалки за один стрибок.',
			},
			{ term: 'T2B (Toes to Bar)', definition: 'ніг до перекладини.' },
			{ term: 'UB (Unbroken)', definition: 'без перерви.' },
			{
				term: 'V-Ups',
				definition: 'підйом ніг та корпусу в положенні сидячи.',
			},
			{ term: 'WOD (Workout of the Day)', definition: 'тренування дня.' },
			{
				term: 'Wall Ball',
				definition: 'вправа з м’ячем, що кидається у стіну.',
			},
			{ term: 'Wrist Wrap', definition: 'обгортка для зап’ястя.' },
			{ term: 'X-fit', definition: 'кросфіт.' },
			{ term: 'Yoke', definition: 'переносна конструкція для ваги.' },
			{ term: 'Zercher Squat', definition: 'присідання в захваті.' },
		]
